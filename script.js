...
const skills = [
{ text: 'C#', size: 16, color: 'lightblue' },
{ text: 'OpenCV', size: 10, color: 'orange' },
{ text: 'Machine Learning', size: 15, color: 'chartreuse' },
{ text: 'Python', size: 13, color: 'lightgreen' },
{ text: 'DJango', size: 17, color: 'darkgreen' }];
...
function Circle(x, y, radius, color, blurSize, text) {
  ...
  this.distanceCenter = getRandomRange(50, innerWidth / 8);
